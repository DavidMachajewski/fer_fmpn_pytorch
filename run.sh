...
for %i in (8) do (for %j in (0) do python main.py --mode train --gpu_id 0 --model_to_train fmpn --epochs 304 --save_ckpt_intv 100 --load_size 320 --final_size 299 --load_ckpt_fmg_only 1 --fmpn_cn inc_v3 --fmpn_cn_pretrained %j --dataset ckp --batch_size 8 --scheduler_type linear_x --ckpt_fmg "F:\trainings2\fmg\8\run_fmg_2021-06-22_20-21-22\train_fmg_2021-06-22_20-21-22\ckpt\fmg_2021-06-22_20-21-22_epoch_299_ckpt.pth.tar" --trainsplit train_ids_%i.csv --testsplit test_ids_%i.csv)
