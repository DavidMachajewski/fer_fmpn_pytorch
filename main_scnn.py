...
if __name__ == "__main__":
    ...
    args.lr_gen = 0.0005
    args.load_size = 299
    args.final_size = 299   # rafdb Net input size
    args.n_classes = 7  # if you use n_classes 6 then delete class nr 7!!!! otherwise 7
    # args.remove_class = 7
    args.scnn_llfeatures = 256  # 512 # 1024  # 2048 # 4096  # reduce it later if overfitting occures
    ...
    print(summary(scnn_agent.model, (1, 299, 299)))
